...
**Next:** Step 9.7 — About panel. Version, build commit SHA, link to source. Build info injected at Vite build time. Output `AboutPanel.tsx`. Done when live build shows the actual commit hash. Closes Phase 9.
