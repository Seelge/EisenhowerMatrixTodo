...
**Next:** Step 8.9 — Close behavior. Closing view3 returns the user to whichever view (view1 or view2) was visible when it opened, recorded by `openedFromZoom` in `ViewState` (Step 1.7). Done when opening from view1 → close → land on view1, and opening from view2/Q3 → close → land on view2/Q3.
