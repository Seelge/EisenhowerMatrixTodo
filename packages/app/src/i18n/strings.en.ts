...
export const strings = {
  ...
  'app.task.fields.status.reopen': 'Reopen',
  'app.due.today': 'Today',
  'app.due.tomorrow': 'Tomorrow',
  'app.due.weekend': 'This weekend',
  'app.due.nextWeek': 'Next week',
  'app.due.none': 'No date',
  'app.due.quickGroup': 'Quick due dates',
  'app.due.pickDate': 'Pick a date',
