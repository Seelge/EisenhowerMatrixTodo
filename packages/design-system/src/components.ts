...
.emt-scrim {
  ...
  animation: emt-fade-in var(--motion-duration-medium) var(--motion-easing-standard);
}
...
.emt-sheet {
  ...
  overflow-y: auto;
  animation: emt-slide-up var(--motion-duration-medium) var(--motion-easing-emphasized);
}
